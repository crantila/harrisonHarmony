...
class TestConditionForFunction( unittest.TestCase ):
   ...
   def test_equal_dependencies_with_HarFuncNote( self ):
      ...
      a = ConditionForFunction( ConditionForFunction.IsLowestVoice, HHarmonicFunctionalNote( key.Key('C'), HarmonicFunction.Tonic, FunctionalRole.Base, '1' ) )
      b = ConditionForFunction( ConditionForFunction.IsLowestVoice, HHarmonicFunctionalNote( key.Key('C'), HarmonicFunction.Tonic, FunctionalRole.Base, '1' ) )
      self.assertTrue( a.equal( b ) )
      self.assertTrue( b.equal( a ) )
      a = ConditionForFunction( ConditionForFunction.IsLowestVoice, HHarmonicFunctionalNote( key.Key('C'), HarmonicFunction.Tonic, FunctionalRole.Base, '1' ) )
      b = ConditionForFunction( ConditionForFunction.IsLowestVoice, HHarmonicFunctionalNote( key.Key('C'), HarmonicFunction.Tonic, FunctionalRole.Agent, '3' ) )
      self.assertEqual( a.equal( b ), False )
      self.assertEqual( b.equal( a ), False )
      a = ConditionForFunction( ConditionForFunction.IsLowestVoice, HHarmonicFunctionalNote( key.Key('C'), HarmonicFunction.Tonic, FunctionalRole.Base, '1' ) )
      b = ConditionForFunction( ConditionForFunction.IsPresent, HHarmonicFunctionalNote( key.Key('C'), HarmonicFunction.Tonic, FunctionalRole.Agent, '-3' ) )
      self.assertEqual( a.equal( b ), False )
      self.assertEqual( b.equal( a ), False )
#-------------------------------------------------------------------------------
...
class TestHarmonicFunctionalNote( unittest.TestCase ):
   def test_str( self ):
      self.assertEqual( str(HHarmonicFunctionalNote( key.Key('c'), HarmonicFunction.Tonic, FunctionalRole.Agent, '3' )), '^3 as Tonic agent in C' )
      self.assertEqual( str(HHarmonicFunctionalNote( key.Key('c'), HarmonicFunction.Tonic, FunctionalRole.Agent, '-3' )), '^-3 as Tonic agent in C' )
      self.assertEqual( str(HHarmonicFunctionalNote( key.Key('C'), HarmonicFunction.Tonic, FunctionalRole.Agent, '3' )), '^3 as Tonic agent in C' )
      self.assertEqual( str(HHarmonicFunctionalNote( key.Key('c'), HarmonicFunction.Subdominant, FunctionalRole.Associate, '1' )), '^1 as Subdominant associate in C' )
      self.assertEqual( str(HHarmonicFunctionalNote( key.Key('c#'), HarmonicFunction.Tonic, FunctionalRole.Agent, '3' )), '^3 as Tonic agent in C#' )
      self.assertEqual( str(HHarmonicFunctionalNote( key.Key('c#'), HarmonicFunction.Tonic, FunctionalRole.Agent, '-3' )), '^-3 as Tonic agent in C#' )
      self.assertEqual( str(HHarmonicFunctionalNote( key.Key('C#'), HarmonicFunction.Tonic, FunctionalRole.Agent, '3' )), '^3 as Tonic agent in C#' )
      self.assertEqual( str(HHarmonicFunctionalNote( key.Key('C#'), HarmonicFunction.Tonic, FunctionalRole.Agent, '-3' )), '^-3 as Tonic agent in C#' )
   ...
   def test_getLabel( self ):
      a = HHarmonicFunctionalNote( key.Key( 'D-' ), HarmonicFunction.Subdominant, FunctionalRole.Associate, '1' )
      self.assertEqual( a.getLabel(), 'D-:Sas' )
      a = HHarmonicFunctionalNote( key.Key( 'F' ), HarmonicFunction.Unknown, FunctionalRole.Unknown, '-4' )
      self.assertEqual( a.getLabel(), 'F:Uun' )
      a = HHarmonicFunctionalNote( key.Key( 'F#' ), HarmonicFunction.Tonic, FunctionalRole.Agent, '3' )
      self.assertEqual( a.getLabel(), 'F#:Tag' )
      a = HHarmonicFunctionalNote( key.Key( 'E' ), HarmonicFunction.Dominant, FunctionalRole.Base, '5' )
      self.assertEqual( a.getLabel(), 'E:Dba' )
   
   def test_equal( self ):
      # HFNs are the same
      a = HHarmonicFunctionalNote( key.Key( 'F#' ), HarmonicFunction.Dominant, FunctionalRole.Agent, '7' )
      b = HHarmonicFunctionalNote( key.Key( 'F#' ), HarmonicFunction.Dominant, FunctionalRole.Agent, '7' )
      self.assertTrue( a.equal( b ) )
      self.assertTrue( b.equal( a ) )
      ...
      self.assertEqual( b.equal( a ), False )
      # role is different
      b = HHarmonicFunctionalNote( key.Key( 'F#' ), HarmonicFunction.Dominant, FunctionalRole.Base, '-7' )
      self.assertEqual( a.equal( b ), False )
      self.assertEqual( b.equal( a ), False )
      # function is different
      b = HHarmonicFunctionalNote( key.Key( 'F#' ), HarmonicFunction.Tonic, FunctionalRole.Agent, '-7' )
      self.assertEqual( a.equal( b ), False )
      self.assertEqual( b.equal( a ), False )
...
class TestHarmonicFunctionalChord( unittest.TestCase ):
   ...
   def test_init( self ):
      ...
      CM = key.Key( 'C' )
      a = HHarmonicFunctionalNote( CM, HarmonicFunction.Tonic, FunctionalRole.Base, '1' )
      b = HHarmonicFunctionalNote( CM, HarmonicFunction.Tonic, FunctionalRole.Agent, '3' )
      c = HHarmonicFunctionalNote( CM, HarmonicFunction.Tonic, FunctionalRole.Associate, '5' )
   ...
   def test_str( self ):
      CM = key.Key( 'C' )
      HFN = lambda a, b, c, d: HHarmonicFunctionalNote( a, b, c, d )
      HFC = lambda a, b, c = None : HarmonicFunctionalChord( a, b, c )
      # the doc-tests
      a = HHarmonicFunctionalNote( key.Key( 'C' ), HarmonicFunction.Tonic, FunctionalRole.Agent, '3' )
      b = HHarmonicFunctionalNote( key.Key( 'C' ), HarmonicFunction.Tonic, FunctionalRole.Base, '1' )
      c = HHarmonicFunctionalNote( key.Key( 'C' ), HarmonicFunction.Tonic, FunctionalRole.Associate, '5' )
      self.assertEqual( str(HarmonicFunctionalChord( b, [a, c, b] )), 'T(1)' )
      d = HHarmonicFunctionalNote( key.Key( 'C' ), HarmonicFunction.Subdominant, FunctionalRole.Agent, '-6' )
   ...
   def test_equal( self ):
      a = HHarmonicFunctionalNote( key.Key('C'), self.T, self.bas, '1' )
      b = HHarmonicFunctionalNote( key.Key('C'), self.T, self.age, '3' )
      c = HHarmonicFunctionalNote( key.Key('C'), self.T, self.ass, '5' )
      d = HHarmonicFunctionalNote( key.Key('C'), self.D, self.bas, '5' )
      e = HHarmonicFunctionalNote( key.Key('c'), self.T, self.age, '3' ) # c minor -- should be equivalent to b
   ...
   def test_getVerboseLabel( self ):
      Tag = HHarmonicFunctionalNote( key.Key( 'C' ), self.T, self.age, '3' )
      Tba = HHarmonicFunctionalNote( key.Key( 'C' ), self.T, self.bas, '1' )
      Tas = HHarmonicFunctionalNote( key.Key( 'C' ), self.T, self.ass, '5' )
...
class TestPossibleFunctionsFromScaleDegree( unittest.TestCase ):
   ...
   def test_equalsMaker( self ):
      CM = key.Key( 'C' )
      self.assertTrue( self.equalsMaker( [[HHarmonicFunctionalNote(CM,self.T,self.age,'3'),ConditionForFunction(self.guaranteed,0)]], [[HHarmonicFunctionalNote(CM,self.T,self.age,'3'),ConditionForFunction(self.guaranteed,0)]] ) )
      self.assertFalse( self.equalsMaker( [[HHarmonicFunctionalNote(CM,self.T,self.bas,'1'),ConditionForFunction(self.guaranteed,0)]], [[HHarmonicFunctionalNote(CM,self.T,self.age,'3'),ConditionForFunction(self.guaranteed,0)]] ) )
   
   def test_agent_major( self ):
      CM = key.Key( 'C' )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'3',self.low ), [[HHarmonicFunctionalNote(CM,self.T,self.age,'3'),ConditionForFunction(self.guaranteed,0)]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'6',self.low ), [[HHarmonicFunctionalNote(CM,self.S,self.age,'6'),ConditionForFunction(self.guaranteed,0)]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'7',self.low ), [[HHarmonicFunctionalNote(CM,self.D,self.age,'7'),ConditionForFunction(self.guaranteed,0)]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'3',self.mid ), [[HHarmonicFunctionalNote(CM,self.T,self.age,'3'),ConditionForFunction(self.guaranteed,0)]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'6',self.mid ), [[HHarmonicFunctionalNote(CM,self.S,self.age,'6'),ConditionForFunction(self.guaranteed,0)]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'7',self.mid ), [[HHarmonicFunctionalNote(CM,self.D,self.age,'7'),ConditionForFunction(self.guaranteed,0)]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'3',self.hig ), [[HHarmonicFunctionalNote(CM,self.T,self.age,'3'),ConditionForFunction(self.guaranteed,0)]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'6',self.hig ), [[HHarmonicFunctionalNote(CM,self.S,self.age,'6'),ConditionForFunction(self.guaranteed,0)]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'7',self.hig ), [[HHarmonicFunctionalNote(CM,self.D,self.age,'7'),ConditionForFunction(self.guaranteed,0)]] ) )
   ...
   def test_agent_minor( self ):
      ...
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'-3',self.low ), \
                        [[HHarmonicFunctionalNote(key.Key("G"),self.S,self.age,'-3'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(key.Key('G'),self.S,self.bas,'4'))], \
                           [HHarmonicFunctionalNote(CM,self.T,self.age,'-3'),ConditionForFunction(self.guaranteed,0)]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'-6',self.low ), \
                        [[HHarmonicFunctionalNote(key.Key("C"),self.S,self.age,'-6'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(key.Key('C'),self.S,self.bas,'4'))], \
                           [HHarmonicFunctionalNote(CM,self.S,self.age,'-6'),ConditionForFunction(self.guaranteed,0)]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'-7',self.low ), \
                        [[HHarmonicFunctionalNote(key.Key("D"),self.S,self.age,'-7'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(key.Key('D'),self.S,self.bas,'4'))], \
                           [HHarmonicFunctionalNote(CM,self.D,self.age,'-7'),ConditionForFunction(self.guaranteed,0)]] ) )
   ...
   def test_base_lowest( self ):
      ...
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'1',self.low ), \
            [[HHarmonicFunctionalNote(CM,self.T,self.bas,'1'),ConditionForFunction(self.guaranteed,0)]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'4',self.low ), \
            [[HHarmonicFunctionalNote(CM,self.S,self.bas,'4'),ConditionForFunction(self.guaranteed,0)]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'5',self.low ), \
            [[HHarmonicFunctionalNote(CM,self.D,self.bas,'5'),ConditionForFunction(self.guaranteed,0)]] ) )
   
   def test_base_middle_highest( self ):
      CM = key.Key( 'C' )
      ## ^4 is kind of stuck
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'4',self.mid ), \
            [[HHarmonicFunctionalNote(CM,self.S,self.bas,'4'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(CM,self.S,self.age,'6'))], \
            [HHarmonicFunctionalNote(CM,self.S,self.bas,'4'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(CM,self.S,self.age,'-6'))]] ) )
      ...
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'1',self.mid ), \
            [[HHarmonicFunctionalNote(CM,self.T,self.bas,'1'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(CM,self.T,self.age,'3'))], \
            [HHarmonicFunctionalNote(CM,self.T,self.bas,'1'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(CM,self.T,self.age,'-3'))], \
            [HHarmonicFunctionalNote(CM,self.S,self.ass,'1'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(CM,self.S,self.age,'6'))], \
            [HHarmonicFunctionalNote(CM,self.S,self.ass,'1'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(CM,self.S,self.age,'-6'))], \
            [HHarmonicFunctionalNote(CM,self.S,self.ass,'1'),ConditionForFunction(self.isLowest,HHarmonicFunctionalNote(CM,self.S,self.bas,'4'))]] ) )
      ...
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'5',self.mid ), \
            [[HHarmonicFunctionalNote(CM,self.D,self.bas,'5'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(CM,self.D,self.age,'7'))], \
            [HHarmonicFunctionalNote(CM,self.D,self.bas,'5'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(CM,self.D,self.age,'-7'))], \
            [HHarmonicFunctionalNote(CM,self.T,self.ass,'1'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(CM,self.T,self.age,'3'))], \
            [HHarmonicFunctionalNote(CM,self.T,self.ass,'1'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(CM,self.T,self.age,'-3'))], \
            [HHarmonicFunctionalNote(CM,self.T,self.ass,'1'),ConditionForFunction(self.isLowest,HHarmonicFunctionalNote(CM,self.T,self.bas,'1'))]] ) )
   ...
   def test_diatonic_degree_2( self ):
      ...
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'2',self.low ), \
            [[HHarmonicFunctionalNote(CM,self.D,self.ass,'2'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(CM,self.D,self.age,'7'))], \
            [HHarmonicFunctionalNote(CM,self.D,self.ass,'2'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(CM,self.D,self.age,'-7'))]] ) )
      ...
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'2',self.mid ), \
            [[HHarmonicFunctionalNote(CM,self.D,self.ass,'2'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(CM,self.D,self.age,'7'))], \
            [HHarmonicFunctionalNote(CM,self.D,self.ass,'2'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(CM,self.D,self.age,'-7'))], \
            [HHarmonicFunctionalNote(CM,self.D,self.ass,'2'),ConditionForFunction(self.isLowest,HHarmonicFunctionalNote(CM,self.D,self.bas,'5'))]] ) )
   ...
   def test_single_flat_degrees( self ):
      ...
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'-1',self.low ), \
            [[HHarmonicFunctionalNote(key.Key("E-"),self.S,self.age,'-1'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(key.Key('E-'),self.S,self.bas,'4'))]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'-1',self.mid ), \
            [[HHarmonicFunctionalNote(key.Key("E-"),self.S,self.age,'-1'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(key.Key('E-'),self.S,self.bas,'4'))]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'-1',self.hig ), \
            [[HHarmonicFunctionalNote(key.Key("E-"),self.S,self.age,'-1'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(key.Key('E-'),self.S,self.bas,'4'))]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'-2',self.low ), \
            [[HHarmonicFunctionalNote(key.Key("F"),self.S,self.age,'-2'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(key.Key('F'),self.S,self.bas,'4'))]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'-2',self.mid ), \
            [[HHarmonicFunctionalNote(key.Key("F"),self.S,self.age,'-2'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(key.Key('F'),self.S,self.bas,'4'))]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'-2',self.hig ), \
            [[HHarmonicFunctionalNote(key.Key("F"),self.S,self.age,'-2'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(key.Key('F'),self.S,self.bas,'4'))]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'-4',self.low ), \
            [[HHarmonicFunctionalNote(key.Key("A-"),self.S,self.age,'-4'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(key.Key('A-'),self.S,self.bas,'4'))]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'-4',self.mid ), \
            [[HHarmonicFunctionalNote(key.Key("A-"),self.S,self.age,'-4'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(key.Key('A-'),self.S,self.bas,'4'))]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'-4',self.hig ), \
            [[HHarmonicFunctionalNote(key.Key("A-"),self.S,self.age,'-4'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(key.Key('A-'),self.S,self.bas,'4'))]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'-5',self.low ), \
            [[HHarmonicFunctionalNote(key.Key("B-"),self.S,self.age,'-5'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(key.Key('B-'),self.S,self.bas,'4'))]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'-5',self.mid ), \
            [[HHarmonicFunctionalNote(key.Key("B-"),self.S,self.age,'-5'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(key.Key('B-'),self.S,self.bas,'4'))]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'-5',self.hig ), \
            [[HHarmonicFunctionalNote(key.Key("B-"),self.S,self.age,'-5'),ConditionForFunction(self.isPresent,HHarmonicFunctionalNote(key.Key('B-'),self.S,self.bas,'4'))]] ) )
   ...
   def test_single_sharp_degrees( self ):
      ...
      ### also, it's an applied Agent, so it's pretty powerful... but we need some reason to believe it's not just a regular NHT
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#1',self.low ), \
                              [[HHarmonicFunctionalNote(key.Key("D"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'5')],
                              [HHarmonicFunctionalNote(key.Key("D"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#1',self.mid ), \
                              [[HHarmonicFunctionalNote(key.Key("D"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'5')],
                              [HHarmonicFunctionalNote(key.Key("D"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#1',self.hig ), \
                              ...
                              [HHarmonicFunctionalNote(key.Key("D"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#2',self.low ), \
                              [[HHarmonicFunctionalNote(key.Key("E"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'5')],
                              [HHarmonicFunctionalNote(key.Key("E"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#2',self.mid ), \
                              [[HHarmonicFunctionalNote(key.Key("E"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'5')],
                              [HHarmonicFunctionalNote(key.Key("E"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#2',self.hig ), \
                              ...
                              [HHarmonicFunctionalNote(key.Key("E"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#3',self.low ), \
                              [[HHarmonicFunctionalNote(key.Key("F#"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'5')],
                              [HHarmonicFunctionalNote(key.Key("F#"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#3',self.mid ), \
                              [[HHarmonicFunctionalNote(key.Key("F#"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'5')],
                              [HHarmonicFunctionalNote(key.Key("F#"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#3',self.hig ), \
                              ...
                              [HHarmonicFunctionalNote(key.Key("F#"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#4',self.low ), \
                              [[HHarmonicFunctionalNote(key.Key("G"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'5')],
                              [HHarmonicFunctionalNote(key.Key("G"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#4',self.mid ), \
                              [[HHarmonicFunctionalNote(key.Key("G"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'5')],
                              [HHarmonicFunctionalNote(key.Key("G"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#4',self.hig ), \
                              ...
                              [HHarmonicFunctionalNote(key.Key("G"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#5',self.low ), \
                              [[HHarmonicFunctionalNote(key.Key("A"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'5')],
                              [HHarmonicFunctionalNote(key.Key("A"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#5',self.mid ), \
                              [[HHarmonicFunctionalNote(key.Key("A"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'5')],
                              [HHarmonicFunctionalNote(key.Key("A"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#5',self.hig ), \
                              ...
                              [HHarmonicFunctionalNote(key.Key("A"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#6',self.low ), \
                              [[HHarmonicFunctionalNote(key.Key("B"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'5')],
                              [HHarmonicFunctionalNote(key.Key("B"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#6',self.mid ), \
                              [[HHarmonicFunctionalNote(key.Key("B"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'5')],
                              [HHarmonicFunctionalNote(key.Key("B"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#6',self.hig ), \
                              ...
                              [HHarmonicFunctionalNote(key.Key("B"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#7',self.low ), \
                              [[HHarmonicFunctionalNote(key.Key("C#"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'5')],
                              [HHarmonicFunctionalNote(key.Key("C#"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#7',self.mid ), \
                              [[HHarmonicFunctionalNote(key.Key("C#"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'5')],
                              [HHarmonicFunctionalNote(key.Key("C#"),self.D,self.age,'7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] ) )
      self.assertTrue( self.equalsMaker( possibleFunctionsFromScaleDegree( CM,'#7',self.hig ), \
...
################# Test Function ################################################
#def chkExp( testArg, readableTestArg, exp ):
   #result = reconcileTheseFunctions( testArg )
   #if 1 != exp.equal( result ):
      #print( "Error: " + readableTestArg + " yields <" + result.getVerboseLabel() + "> instead of <" + exp.getVerboseLabel() + ">" )

################ Tests ########################################################
## NOTE: For all these tests, the bass note is the first element in the first argument to chkExp.
## Primary triads in root position and first inversion




### Diatonic triads in second inversion


### Some seventh chords
## chkExp( [l,m,m,h], "[l,m,m,h]", HarmonicFunctionalChord( HarmonicFunctionalNote(self.CM,,,''), [HarmonicFunctionalNote(self.CM,,,''),HarmonicFunctionalNote(self.CM,,,''),HarmonicFunctionalNote(self.CM,,,'')] ) )


### Some arbitrary assemblages
### (Targeted testing of things that seem to fail)
## chkExp( [l,m,m,h], "[l,m,m,h]", HarmonicFunctionalChord( HarmonicFunctionalNote(self.CM,,,''), [HarmonicFunctionalNote(self.CM,,,''),HarmonicFunctionalNote(self.CM,,,''),HarmonicFunctionalNote(self.CM,,,'')] ) )


## Some Dominant applied chords -- note the expected key is not always CM
# chkExp( [l,m,m,h], "[l,m,m,h]", HarmonicFunctionalChord( HarmonicFunctionalNote(self.CM,,,''), [HarmonicFunctionalNote(self.CM,,,''),HarmonicFunctionalNote(self.CM,,,''),HarmonicFunctionalNote(self.CM,,,'')] ) )
# have ^#2 and ^#4
#chkExp( [l2,ms4,m2,h6], "[l2,ms4,m2,h6]", HarmonicFunctionalChord( HarmonicFunctionalNote(GM,self.D,self.bas,'5'), [HarmonicFunctionalNote(GM,self.D,self.age,'7'),HarmonicFunctionalNote(self.CM,self.D,self.bas,'5'),HarmonicFunctionalNote(GM,self.D,self.ass,'2')] ) ) # V / ^5
#chkExp( [ls4,m6,m1,h6], "[ls4,m6,m1,h6]", HarmonicFunctionalChord( HarmonicFunctionalNote(GM,self.D,self.age,'7'), [HarmonicFunctionalNote(GM,self.D,self.ass,'2'),HarmonicFunctionalNote(GM,self.U,self.unk,'4'),HarmonicFunctionalNote(GM,self.D,self.ass,'2')] ) ) # vii-dim / ^5
#chkExp( [l6,ms4,m6,hs4], "[l6,ms4,m6,hs4]", HarmonicFunctionalChord( HarmonicFunctionalNote(self.CM,self.S,self.age,'6'), [HarmonicFunctionalNote(self.CM,self.U,self.unk,'#4'),HarmonicFunctionalNote(self.CM,self.S,self.age,'6'),HarmonicFunctionalNote(self.CM,self.U,self.unk,'#4')] ) ) # ^#4 and ^6 = nothing
#chkExp( [l2,m6,m1,hs4], "[l2,m6,m1,hs4]", HarmonicFunctionalChord( HarmonicFunctionalNote(GM,self.D,self.bas,'5'), [HarmonicFunctionalNote(GM,self.D,self.ass,'2'),HarmonicFunctionalNote(self.CM,self.U,self.unk,'1'),HarmonicFunctionalNote(GM,self.D,self.age,'7')] ) ) # V7 / ^5
#chkExp( [ls4,m2,m6,h2], "[ls4,m2,m6,h2]", HarmonicFunctionalChord( HarmonicFunctionalNote(self.CM,self.D,self.age,'7'), [HarmonicFunctionalNote(GM,self.D,self.bas,'5'),HarmonicFunctionalNote(GM,self.D,self.ass,'2'),HarmonicFunctionalNote(GM,self.D,self.bas,'5')] ) ) # V6 / ^5
#chkExp( [l7,ms2,m7,hs4], "[l7,ms2,m7,hs4]", HarmonicFunctionalChord( HarmonicFunctionalNote(EM,self.D,self.bas,'5'), [HarmonicFunctionalNote(EM,self.D,self.age,'7'),HarmonicFunctionalNote(EM,self.D,self.bas,'5'),HarmonicFunctionalNote(EM,self.D,self.ass,'2')] ) ) # V / ^3
#chkExp( [ls2,ms4,m6,hs4], "[ls2,ms4,m6,hs4]", HarmonicFunctionalChord( HarmonicFunctionalNote(EM,self.D,self.age,'7'), [HarmonicFunctionalNote(EM,self.D,self.ass,'2'),HarmonicFunctionalNote(EM,self.U,self.unk,'4'),HarmonicFunctionalNote(EM,self.D,self.ass,'2')] ) ) # vii-dim / ^3
#chkExp( [ls4,ms2,ms4,hs2], "[ls4,ms2,ms4,hs2]", HarmonicFunctionalChord( HarmonicFunctionalNote(self.CM,self.S,self.age,'6'), [HarmonicFunctionalNote(self.CM,self.U,self.unk,'#2'),HarmonicFunctionalNote(self.CM,self.U,self.unk,'#4'),HarmonicFunctionalNote(self.CM,self.U,self.unk,'#2')] ) ) # ^#2 and ^#4 = nothing (except this time maybe it is something... )
#chkExp( [l7,ms4,m6,hs2], "[l7,ms4,m6,hs2]", HarmonicFunctionalChord( HarmonicFunctionalNote(EM,self.D,self.bas,'5'), [HarmonicFunctionalNote(EM,self.D,self.ass,'#4'),HarmonicFunctionalNote(self.CM,self.S,self.age,'6'),HarmonicFunctionalNote(EM,self.D,self.age,'7')] ) ) # V7 / ^3
#chkExp( [ls2,m7,ms4,h7], "[ls2,m7,ms4,h7]", HarmonicFunctionalChord( HarmonicFunctionalNote(EM,self.D,self.age,'7'), [HarmonicFunctionalNote(EM,self.D,self.bas,'5'),HarmonicFunctionalNote(EM,self.D,self.ass,'#4'),HarmonicFunctionalNote(EM,self.D,self.bas,'5')] ) ) # V6 / ^3

### Some Subdominant applied chords -- note the expected key is not always CM
## chkExp( [l,m,m,h], "", HarmonicFunctionalChord( HarmonicFunctionalNote(self.CM,,,''), [HarmonicFunctionalNote(self.CM,,,''),HarmonicFunctionalNote(self.CM,,,''),HarmonicFunctionalNote(self.CM,,,'')] ) )
## have ^-2 and ^-4 and ^-1
#chkExp( [lf2,mf4,mf2,hf6], "[lf2,mf4,mf2,hf6]", HarmonicFunctionalChord( HarmonicFunctionalNote(AfM,self.S,self.bas,'4'), [HarmonicFunctionalNote(AfM,self.S,self.age,'-6'),HarmonicFunctionalNote(AfM,self.S,self.bas,'4'),HarmonicFunctionalNote(AfM,self.S,self.ass,'1')] ) ) # S / ^3
#chkExp( [lf4,mf6,mf2,hf6], "[lf4,mf6,mf2,hf6]", HarmonicFunctionalChord( HarmonicFunctionalNote(AfM,self.S,self.age,'-6'), [HarmonicFunctionalNote(AfM,self.S,self.ass,'1'),HarmonicFunctionalNote(AfM,self.S,self.bas,'4'),HarmonicFunctionalNote(AfM,self.S,self.ass,'1')] ) ) # S-age in bass / ^3
#chkExp( [lf2,mf6,mf1,hf4], "[lf2,mf6,mf1,hf4]", HarmonicFunctionalChord( HarmonicFunctionalNote(AfM,self.S,self.bas,'4'), [HarmonicFunctionalNote(AfM,self.S,self.ass,'1'),HarmonicFunctionalNote(self.CM,self.U,self.unk,'-1'),HarmonicFunctionalNote(AfM,self.S,self.age,'-6')] ) ) # S7 / ^3
