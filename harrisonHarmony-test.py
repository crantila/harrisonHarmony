...
class TestRelativeVoicePosition( unittest.TestCase ):
   def test_toLetter( self ):
      self.assertEqual( RelativeVoicePosition.toLetter( RelativeVoicePosition.Highest ), 'self.highest' )
      self.assertEqual( RelativeVoicePosition.toLetter( RelativeVoicePosition.Middle ), 'self.middle' )
      self.assertEqual( RelativeVoicePosition.toLetter( RelativeVoicePosition.Lowest ), 'self.lowest' )
   ...
   def test_str( self ):
      self.assertEqual( str(RelativeVoicePosition.Highest()), 'self.highest' )
      self.assertEqual( str(RelativeVoicePosition.Middle()), 'self.middle' )
      self.assertEqual( str(RelativeVoicePosition.Lowest()), 'self.lowest' )
...
class TestConditionForFunction( unittest.TestCase ):
   def test_str( self ):
      ...
      self.assertEqual( str(ConditionForFunction( ConditionForFunction.IsLowestVoice, 'A' )), 'true if self.lowest voice is A' )
...
class TestPossibleFunctionsFromScaleDegree( unittest.TestCase ):
   ...
   def test_single_sharp_degrees( self ):
      ...
      ###   -the degrees a minor third above and a minor third above that are present (vii of something)
      ### also, it's an applied Agent, so it's pretty powerful... but we need some reason to believe it's not just a regular NHT
      self.assertEqual( [CM,'#1',self.low], [[HarmonicFunctionalNote(key.Key("D"),self.D,self.age,'#1'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("D"),self.D,self.age,'#1'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#1',self.mid], [[HarmonicFunctionalNote(key.Key("D"),self.D,self.age,'#1'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("D"),self.D,self.age,'#1'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#1',self.hig], [[HarmonicFunctionalNote(key.Key("D"),self.D,self.age,'#1'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("D"),self.D,self.age,'#1'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#2',self.low], [[HarmonicFunctionalNote(key.Key("E"),self.D,self.age,'#2'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("E"),self.D,self.age,'#2'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#2',self.mid], [[HarmonicFunctionalNote(key.Key("E"),self.D,self.age,'#2'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("E"),self.D,self.age,'#2'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#2',self.hig], [[HarmonicFunctionalNote(key.Key("E"),self.D,self.age,'#2'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("E"),self.D,self.age,'#2'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#3',self.low], [[HarmonicFunctionalNote(key.Key("F#"),self.D,self.age,'#3'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("F#"),self.D,self.age,'#3'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#3',self.mid], [[HarmonicFunctionalNote(key.Key("F#"),self.D,self.age,'#3'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("F#"),self.D,self.age,'#3'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#3',self.hig], [[HarmonicFunctionalNote(key.Key("F#"),self.D,self.age,'#3'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("F#"),self.D,self.age,'#3'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#4',self.low], [[HarmonicFunctionalNote(key.Key("G"),self.D,self.age,'#4'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("G"),self.D,self.age,'#4'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#4',self.mid], [[HarmonicFunctionalNote(key.Key("G"),self.D,self.age,'#4'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("G"),self.D,self.age,'#4'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#4',self.hig], [[HarmonicFunctionalNote(key.Key("G"),self.D,self.age,'#4'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("G"),self.D,self.age,'#4'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#5',self.low], [[HarmonicFunctionalNote(key.Key("A"),self.D,self.age,'#5'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("A"),self.D,self.age,'#5'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#5',self.mid], [[HarmonicFunctionalNote(key.Key("A"),self.D,self.age,'#5'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("A"),self.D,self.age,'#5'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#5',self.hig], [[HarmonicFunctionalNote(key.Key("A"),self.D,self.age,'#5'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("A"),self.D,self.age,'#5'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#6',self.low], [[HarmonicFunctionalNote(key.Key("B"),self.D,self.age,'#6'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("B"),self.D,self.age,'#6'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#6',self.mid], [[HarmonicFunctionalNote(key.Key("B"),self.D,self.age,'#6'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("B"),self.D,self.age,'#6'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#6',self.hig], [[HarmonicFunctionalNote(key.Key("B"),self.D,self.age,'#6'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("B"),self.D,self.age,'#6'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#7',self.low], [[HarmonicFunctionalNote(key.Key("C#"),self.D,self.age,'#7'),ConditionForFunction(self.isPresent,'5')],
      ...
      self.assertEqual( [CM,'#7',self.mid], [[HarmonicFunctionalNote(key.Key("C#"),self.D,self.age,'#7'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("C#"),self.D,self.age,'#7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
      self.assertEqual( [CM,'#7',self.hig], [[HarmonicFunctionalNote(key.Key("C#"),self.D,self.age,'#7'),ConditionForFunction(self.isPresent,'5')],
                              [HarmonicFunctionalNote(key.Key("C#"),self.D,self.age,'#7'),ConditionForFunction(self.isPresent,'2'),ConditionForFunction(self.isPresent,'4')]] )
#-------------------------------------------------------------------------------
